...
function init() {
  ...
  platforms = [new Platform({
    x: platformImage.width * 4 + 400 - 2 + platformImage.width - platformSmallTallImage.width,
    y: 270,
...
function animate() {
  ...
  if (keys.right.pressed && player.position.x < 400) {
    ...
    if (keys.right.pressed) {
      ...
      genericObjects.forEach(function (genericObjects) {
        genericObjects.position.x -= player.speed * .75;
      });
...
addEventListener('keydown', function (_ref3) {
  ...
  switch (keyCode) {
    ...
    case "ArrowUp":
      console.log('up');
      player.onPlatform === true ? player.velocity.y += 20 : null;
      break;
  }
});
addEventListener('keyup', function (_ref4) {
  ...
  switch (keyCode) {
    ...
    case 38:
      console.log('up');
      player.onPlatform === true ? player.velocity.y -= 26 : null;
      break;
  }
});
